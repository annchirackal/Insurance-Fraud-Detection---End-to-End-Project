...
class Preprocessor:
    ...
    def read_data(self, input_data_path):
        """
        Loads input data from the given path.
        Args:
        input_data_path (str): Path to input CSV file.
        Output:pd.DataFrame: DataFrame with input data.
        On Failure: Raise Exception 
        """
        try:
            self.df = pd.read_csv(input_data_path)
            self.logger_object.log(self.file_object, 'Successfully loaded input data')
            return self.df
        except Exception as e:
            self.logger_object.log(self.file_object,
                                   'Exception occurred while loading data: ' + str(e))
            raise Exception()
        
   
    def remove_unwanted_spaces_and_characters(self,data):
        """
                ...
                Args :
                data(DataFrame): raw input data as dataframe
                On Failure: Raise Exception  
         """
    ...
    def remove_columns(self,data,columns):
        """
                ...
                Args :
                data(dataframe): dataframe with all columns
                columns(list): colums to remove as list
    ...
    def is_null_present(self,data):
        """
            ...
            Args: Data(dataframe): Dataframe with all desired columns
    ...
    def handle_imbalanced_dataset(self, x, y):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                'Exception occurred in handle_imbalanced_dataset method of the Preprocessor class. Exception message: ' + str(e))
            self.logger_object.log(self.file_object,
